...
// 部署到 GitHub Pages 的 /MiaoChuangShuo/web/ 子路径。
// 复用项目根的 React/Tailwind/PostCSS 配置, 不引入新依赖。
//
// 模块职责:
// 1. 设置 base 路径以匹配 GitHub Pages 子路径
// 2. 配置入口 HTML 与输出目录
