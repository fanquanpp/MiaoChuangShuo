...
export default function ConfirmDialog({
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm bg-nf-bg-card border border-nf-border-light shadow-lg">
        ...
        <div className="px-5 py-4">
          ...
          {type === "prompt" && (
            <input
              ...
              className="w-full bg-nf-bg border border-nf-border-light px-3 py-2 mt-3 text-sm text-nf-text placeholder-nf-text-tertiary focus:outline-none focus:border-fandex-primary/60 transition-fast"
            />
          )}
        </div>
        ...
        <div className="flex justify-end gap-2 px-5 py-3 border-t border-nf-border-light">
          ...
          <button
            ...
            className={`px-3 py-1.5 text-sm font-medium text-nf-text-inverse transition-fast disabled:opacity-50 disabled:cursor-not-allowed ${
              isDanger
