...
> 喵趣创想，放胆述说 —— 一款为长篇创作者打造的离线小说创作工作站

## 项目简介

喵创说（MiaoChuangShuo）是一款专为小说创作者打造的离线写作工作站，将项目管理、章节编辑、角色设定、版本快照、剧情时间线等创作所需的全部能力，整合到一个桌面应用中。

不依赖云端，不需注册，打开即写。让有想法的人不因复杂的文本构建与整理而难以迈出第一步。
